...
local function register_integration(module, name, prefix)
	local commands = module(M)
	if commands then
		M.register_commands(commands, name, prefix)
	end
end

function M.init()
	register_integration(require("commander.integrations.monarch"), "Monarch", "monarch")
	register_integration(require("commander.integrations.orthographic"), "Orthographic", "ortho")
...
M.register_commands(require("commander.internal.commands")(M), "Commander")
